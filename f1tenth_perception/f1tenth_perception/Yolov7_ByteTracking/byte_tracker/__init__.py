import numpy as np
from Yolov7_ByteTracking.byte_tracker import matching
from Yolov7_ByteTracking.byte_tracker.base_track import BaseTrack, TrackState
from Yolov7_ByteTracking.byte_tracker.kalman_filter import KalmanFilter
from Yolov7_ByteTracking.utils.general import xywh2xyxy, xyxy2xywh
...
class BYTETracker(object):
    def __init__(self, track_thresh=0.45, track_buffer=25, match_thresh=0.8, frame_rate=30):
        ...
        # print("You are in BYTETracker")

    def update(self, dets):
        # print("def update: ", dets)
        # print("hello update")
        self.frame_id += 1
        activated_starcks = []
        refind_stracks = []
        ...
        xyxys = dets[:, 0:4]
        # print("xyxys update: ",xyxys)
        xywh = xyxy2xywh(xyxys)
        # print("xywh:",xywh)
        confs = dets[:, 4]
        # print("confs update: ",confs)
        clss = dets[:, 5]
        ...
        if len(dets) > 0:
            ...
            # print('detection update: ',detections)
        else:
            detections = []
        ...
        # print(t for t in self.tracked_stracks if t.state == TrackState.Tracked)
        ...
        # print("output_stracks update: ",output_stracks)
        outputs = []
